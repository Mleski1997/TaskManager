...
export const startEditing = (taskId, todo,setIsEditing,setEditingTask, title, description, dueDate, format,status ) => {
	setIsEditing(true)
...
export async function clearFormFields(title, description, dueDate, status) {
	title.current.value = ''
